module.exports = {
    ...
    registration: {
        ...
        findRegistrationsByDate: 'select r.*, sp.`name` as shiftPeriodName from Registration r, ShiftPeriod sp where sp.id =r.shiftPeriod AND r.registerDate = ?'
    },
    ...
    notification: {
        ...
        findAll: 'select * from notification order by id desc limit ?, ?'
    }
}
